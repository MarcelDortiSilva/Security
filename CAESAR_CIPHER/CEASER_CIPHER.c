...
only small, caps or spaces are allowed.
...
printf ("Enter message to be ciphered (only, aA - zZ, and spaces):"); // human interface
...
printf ("Enter the Key of the Caesar Cipher : ");// human interface
